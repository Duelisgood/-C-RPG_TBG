...
// =================================================================
    ...
    // -- Helment --
    {.itemID = 160, .nama = "Topi Kulit Sederhana", .harga = 30, .rarity = 1, .type = "HELMET", .stat_boost = 5},
    {.itemID = 161, .nama = "Helm Mangkuk Besi", .harga = 50, .rarity = 1, .type = "HELMET", .stat_boost = 8},
    {.itemID = 163, .nama = "Tudung Kain", .harga = 25, .rarity = 1, .type = "HELMET", .stat_boost = 4},
    {.itemID = 164, .nama = "Helm Panci", .harga = 45, .rarity = 1, .type = "HELMET", .stat_boost = 7},
    {.itemID = 165, .nama = "Topi Berburu", .harga = 55, .rarity = 1, .type = "HELMET", .stat_boost = 9},
...
// =================================================================
    ...
    // -- Helment --
    {.itemID = 260, .nama = "Helm Prajurit", .harga = 200, .rarity = 2, .type = "HELMET", .stat_boost = 12},
    {.itemID = 261, .nama = "Tudung Pengintai", .harga = 240, .rarity = 2, .type = "HELMET", .stat_boost = 15},
    {.itemID = 263, .nama = "Helm Berduri", .harga = 190, .rarity = 2, .type = "HELMET", .stat_boost = 11},
    {.itemID = 264, .nama = "Helm Infanteri", .harga = 210, .rarity = 2, .type = "HELMET", .stat_boost = 13},
    {.itemID = 265, .nama = "Topeng Perang", .harga = 250, .rarity = 2, .type = "HELMET", .stat_boost = 16},
...
// =================================================================
    ...
    // -- Helment --
    {.itemID = 360, .nama = "Helm Ksatria", .harga = 750, .rarity = 3, .type = "HELMET", .stat_boost = 20},
    {.itemID = 361, .nama = "Topeng Suku", .harga = 850, .rarity = 3, .type = "HELMET", .stat_boost = 25},
    {.itemID = 363, .nama = "Helm Ksatria Baja", .harga = 780, .rarity = 3, .type = "HELMET", .stat_boost = 21},
    {.itemID = 364, .nama = "Helm Tanduk Banteng", .harga = 820, .rarity = 3, .type = "HELMET", .stat_boost = 24},
    {.itemID = 365, .nama = "Mahkota Duri", .harga = 900, .rarity = 3, .type = "HELMET", .stat_boost = 26},
...
// =================================================================
    ...
    // -- Helment --
    {.itemID = 460, .nama = "Helm Mithril", .harga = 3500, .rarity = 4, .type = "HELMET", .stat_boost = 35},
    {.itemID = 461, .nama = "Mahkota Penyihir", .harga = 4000, .rarity = 4, .type = "HELMET", .stat_boost = 45},
    {.itemID = 463, .nama = "Helm Obsidian", .harga = 3700, .rarity = 4, .type = "HELMET", .stat_boost = 38},
    {.itemID = 464, .nama = "Diadem Cahaya Bulan", .harga = 3900, .rarity = 4, .type = "HELMET", .stat_boost = 42},
    {.itemID = 465, .nama = "Helm Komandan", .harga = 4400, .rarity = 4, .type = "HELMET", .stat_boost = 48},
...
// =================================================================
    ...
    // -- Helment --
    {.itemID = 560, .nama = "Helm Naga", .harga = 18000, .rarity = 5, .type = "HELMET", .stat_boost = 60},
    {.itemID = 561, .nama = "Mahkota Raja Kuno", .harga = 25000, .rarity = 5, .type = "HELMET", .stat_boost = 75},
    {.itemID = 563, .nama = "Mahkota Malaikat", .harga = 20000, .rarity = 5, .type = "HELMET", .stat_boost = 70},
    {.itemID = 564, .nama = "Helm Titan", .harga = 28000, .rarity = 5, .type = "HELMET", .stat_boost = 80},
    {.itemID = 565, .nama = "Wajah Dewa Kuno", .harga = 35000, .rarity = 5, .type = "HELMET", .stat_boost = 85},
